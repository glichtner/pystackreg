...
/*********************************************************************
 Start the mask precomputations, which are interruptible.
    ********************************************************************/
void TurboRegMask::init() { this->buildPyramid(); } /* end run */
...
/*********************************************************************
 Converts the pixel array of the incoming <code>ImagePlus</code>
    ...
    ********************************************************************/
TurboRegMask::TurboRegMask(TurboRegImage &img) {
...
TurboRegMask::TurboRegMask(matrix<double> &imp, int width, int height) {
...
/*********************************************************************
 Set the depth up to which the pyramids should be computed.
    ...
    ********************************************************************/
void TurboRegMask::setPyramidDepth(int pyramidDepth) {
...
void TurboRegMask::buildPyramid() {
  ...
  for (int depth = 1; ((depth < pyramidDepth)); depth++) {
    ...
    // std::vector<double> halfMask = getHalfMask2D(fullMask, fullWidth,
    // fullHeight);
...
/*------------------------------------------------------------------*/
std::vector<double> TurboRegMask::getHalfMask2D(double *pFullMask,
